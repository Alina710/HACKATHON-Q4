...
const config: Config = {
  ...
  url: 'https://hackathon-q4-murex.vercel.app/',
  ...
  organizationName: 'alina-classes', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/alina-classes/HACKATHON-Q4',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Technical Documentation Book. Built with Docusaurus.`,
    },
    prism: {
